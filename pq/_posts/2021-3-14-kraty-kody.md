...
pierścień $R_{kod}$ jest pierścieniem ideałów głównych, stąd każdy kod $C$ odpowiadaja pewnemu ideałowi głównemu. wynika stąd, że
dla każdego kodu istnieje element $g$, generujący wszystkie pozostałe słowa kodowe. dodatkowo element $g$ musi być dzielnikiem
