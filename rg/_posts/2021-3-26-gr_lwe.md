...
$$ R_{\mathbb{R}} = R \otimes_{\mathbb{Z}} \mathbb{R},$$
...
niezależnie i jednostajnie od rozkładu $R_q$ i $b_i = a_i \cdot s / q + e_i \mod{R}$, a $e_i$ jest wybierany niezależnie z rozkładu
...
krata dualna do $L$ i odwrotność $L$ są takie same z dokładnością do permutacji współrzędnych.
